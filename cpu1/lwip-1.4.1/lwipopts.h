 ...
 */
#define MEMCPY(dst,src,len)             my_copy((void*)dst,(void*)src,len);//memcpy((BYTE*)dst,(BYTE*)src,(UINT)len)

/**
 * SMEMCPY: override this with care! Some compilers (e.g. gcc) can inline a
 * call to memcpy() if the length is known at compile time and is small.
 */
#define SMEMCPY(dst,src,len)            memcpy((BYTE*)dst,(BYTE*)src,(UINT)len)//my_copy((void*)dst,(void*)src,len)
 ...
 */
#define MEMP_NUM_UDP_PCB                6//10//6
...
/* Max Xmit idle time (in gptMsgShare.TIME) before resend flag char. */
