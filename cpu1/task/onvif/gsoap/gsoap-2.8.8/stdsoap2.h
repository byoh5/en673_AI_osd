...
# define SOAP_SOCKLEN_T SOCKLEN_T
#elif defined(__socklen_t_defined) || defined(EYENIX_OR32) || defined(_SOCKLEN_T) || defined(CYGWIN) || defined(FREEBSD) || defined(__FreeBSD__) || defined(OPENBSD) || defined(__QNX__) || defined(QNX) || defined(OS390) || defined(HP_UX)
# define SOAP_SOCKLEN_T socklen_t
...
# if defined(EYENIX_OR32)
#  define SOAP_MALLOC(soap, size) enx_soap_malloc(soap,size)
# else
...
# if defined(EYENIX_OR32)
# 	define SOAP_FREE(soap, ptr) enx_soap_free(soap,ptr)
# else
...
{ short state;			/* 0 = uninitialized, 1 = initialized, 2 = copy of another soap struct */
  ...
  const char *actor;		/* env:actor or role attribute value */
  const char *lang;		/* xml:lang attribute value of env:Text */
