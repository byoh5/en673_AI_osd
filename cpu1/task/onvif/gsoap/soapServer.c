...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.8 2014-07-03 11:22:34 GMT")


SOAP_FMAC5 int SOAP_FMAC6 soap_serve(struct soap *soap)
{
//	printf(" soapServer soap_serve S\n");
#ifndef WITH_FASTCGI
...
#endif
//	printf(" soapServer soap_serve E\n");

	return SOAP_OK;
}

SOAP_FMAC5 int soap_security_checking(struct soap *soap)
{
#ifdef USE_ONVIF_SECURITY	
	//jprintf("soap_security_checking 1\r\n");	
	char *SecurityToken = soap_wsse_UsernameToken(soap, NULL);

	if(SecurityToken != NULL)
	{
		char *username = soap_wsse_get_Username(soap);
		
		if(username != NULL)
		{//jprintf("soap_security_checking 2\r\n");	
			if(strlen(username) && strcmp(gtUser.strUserId,username)==0)
			{
				dvprintf("(%s, username %s) \r\n", __func__,username);
				
				if(soap_wsse_CheckSecurity(soap) <= 0)	
				{
					if(soap_wsse_verify_Password(soap, gtUser.strUserPw) != SOAP_OK)
					{
						dvprintf("(wsse_verify Fail)\r\n");
				...
				{	dvprintf("(Security Pass)\r\n");
						soap_wsse_delete_Security(soap);
				}
			}
			else
			{
				dvprintf("(username Fail)\r\n");
				return SOAP_USER_ERROR;	
			}
		...
		soap_wsse_delete_Security(soap);
	//jprintf("soap_security_checking E\r\n");	
...
{
//	printf(" soapServer soap_serve_request S\n");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{	
		char *username = soap_wsse_get_Username(soap);
		if(username != NULL && strlen(username) && strcmp(gtUser.strUserId,username)==0)
		{
			dvprintf("<%s, username %s >\r\n", __func__,username);
...
///////////////////////////////                      E V E N T                        //////////////////////////////////////
	...
	//	return soap_serve___tete__GetServiceCapabilities(soap);
	//if (!soap_match_tag(soap, soap->tag, "tev:CreatePullPointSubscription"))
	//	return soap_serve___tete__CreatePullPointSubscription(soap);
	//if (!soap_match_tag(soap, soap->tag, "tev:GetEventProperties"))
	//	return soap_serve___tete__GetEventProperties(soap);
	...
	//	return soap_serve___tetpps__PullMessages(soap);
	//if (!soap_match_tag(soap, soap->tag, "tev:Seek"))
	//	return soap_serve___tetpps__Seek(soap);
	//if (!soap_match_tag(soap, soap->tag, "tev:SetSynchronizationPoint"))
	//	return soap_serve___tetpps__SetSynchronizationPoint(soap);
	if (!soap_match_tag(soap, soap->tag, "tev:PullMessages"))
...
////////////////////////					  DEVICE IO 					   ///////////////////////////////	
	...
	if (!soap_match_tag(soap, soap->tag, "tmd:GetRelayOutputs"))
		return soap_serve___tmd__GetRelayOutputs(soap);
	if (!soap_match_tag(soap, soap->tag, "tmd:SetRelayOutputState"))
...
{	struct __wsdd__Hello soap_tmp___wsdd__Hello;
	//struct SOAP_ENV__Header hello_header;	
	if (soap_action == NULL)
		soap_action = "http://docs.oasis-open.org/ws-dd/ns/discovery/2009/01/Hello";

	/* allocate a new header */
	if (!soap->header)
	{	//printf("discovery_task header soap_malloc s\n");
		soap->header = (struct SOAP_ENV__Header *)soap_malloc(soap, sizeof(struct SOAP_ENV__Header));
		memset(soap->header, 0x00, sizeof(struct SOAP_ENV__Header));
	 	SET_SOAP_ENV__Header(soap, soap->header);
	}
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
	{
		dvprintf("soap_send___wsdd__Hello ERROR\r\n");
...
int 
soap_send___wsdd__ProbeMatches(struct soap *soap, 
	const char *soap_endpoint, 
	const char *soap_action, 
	struct wsdd__ProbeMatchesType *wsdd__ProbeMatches)
{	
	dvprintf("soap_send___wsdd__ProbeMatches\r\n");
...
void 
onvif_fault(struct soap *soap, char * Value,
	char * subcode1,char *subcode2,char *Reason, char *Detail)
{
	dvprintf("onvif_fault\r\n");
	soap->fault = (struct SOAP_ENV__Fault*)soap_malloc(soap,(sizeof(struct SOAP_ENV__Fault)));
	soap->fault->SOAP_ENV__Code = (struct SOAP_ENV__Code*)soap_malloc(soap,(sizeof(struct SOAP_ENV__Code)));
	
	if(strlen(Value)>0)
		soap->fault->SOAP_ENV__Code->SOAP_ENV__Value = soap_strdup(soap, Value);	
	else
		soap->fault->SOAP_ENV__Code->SOAP_ENV__Value = soap_strdup(soap, "env:Sender");
	
	soap->fault->SOAP_ENV__Code->SOAP_ENV__Subcode = (struct SOAP_ENV__Code*)soap_malloc(soap,(sizeof(struct SOAP_ENV__Code)));;
	soap->fault->SOAP_ENV__Code->SOAP_ENV__Subcode->SOAP_ENV__Value = soap_strdup(soap, subcode1);
	...
	soap->fault->SOAP_ENV__Code->SOAP_ENV__Subcode->SOAP_ENV__Subcode->SOAP_ENV__Value = soap_strdup(soap, subcode2);
	soap->fault->SOAP_ENV__Code->SOAP_ENV__Subcode->SOAP_ENV__Subcode->SOAP_ENV__Subcode = NULL;

	soap->fault->SOAP_ENV__Reason = (struct SOAP_ENV__Reason *) soap_malloc(soap, sizeof(struct SOAP_ENV__Reason));
	soap->fault->SOAP_ENV__Reason->SOAP_ENV__Text = soap_strdup(soap, Reason);
	...
	soap->fault->SOAP_ENV__Detail->__type =	SOAP_TYPE_string;
...
{	struct __wsdd__Hello soap_tmp___wsdd__Hello;
	...
	if(soap_security_checking(soap) == SOAP_USER_ERROR)
		return soap->error = SOAP_USER_ERROR;
...
{	struct __dnrd__Hello soap_tmp___dnrd__Hello;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __dnrd__Hello(soap, soap_tmp___dnrd__Hello.tdn__Hello, &tdn__HelloResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
{	struct __dnrd__Bye soap_tmp___dnrd__Bye;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __dnrd__Bye(soap, soap_tmp___dnrd__Bye.tdn__Bye, &tdn__ByeResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
{	struct __dndl__Probe soap_tmp___dndl__Probe;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __dndl__Probe(soap, soap_tmp___dndl__Probe.tdn__Probe, &tdn__ProbeResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
#ifdef USE_EVENT_INTERFACE
#if 0
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tete__GetServiceCapabilities(struct soap *soap)
{	struct __tete__GetServiceCapabilities soap_tmp___tete__GetServiceCapabilities;
	...
	soap_default___tete__GetServiceCapabilities(soap, &soap_tmp___tete__GetServiceCapabilities);
	soap->encodingStyle = NULL;
	if (!soap_get___tete__GetServiceCapabilities(soap, &soap_tmp___tete__GetServiceCapabilities, "-tete:GetServiceCapabilities", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tete__GetServiceCapabilities(soap, soap_tmp___tete__GetServiceCapabilities.tev__GetServiceCapabilities, &tev__GetServiceCapabilitiesResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tete__CreatePullPointSubscription(struct soap *soap)
{	struct __tete__CreatePullPointSubscription soap_tmp___tete__CreatePullPointSubscription;
	...
	soap_default___tete__CreatePullPointSubscription(soap, &soap_tmp___tete__CreatePullPointSubscription);
	soap->encodingStyle = NULL;
	if (!soap_get___tete__CreatePullPointSubscription(soap, &soap_tmp___tete__CreatePullPointSubscription, "-tete:CreatePullPointSubscription", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tete__CreatePullPointSubscription(soap, soap_tmp___tete__CreatePullPointSubscription.tev__CreatePullPointSubscription, &tev__CreatePullPointSubscriptionResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tete__GetEventProperties(struct soap *soap)
{	struct __tete__GetEventProperties soap_tmp___tete__GetEventProperties;
	...
	soap_default___tete__GetEventProperties(soap, &soap_tmp___tete__GetEventProperties);
	soap->encodingStyle = NULL;
	if (!soap_get___tete__GetEventProperties(soap, &soap_tmp___tete__GetEventProperties, "-tete:GetEventProperties", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tete__GetEventProperties(soap, soap_tmp___tete__GetEventProperties.tev__GetEventProperties, &tev__GetEventPropertiesResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tetsm__Renew(struct soap *soap)
{	struct __tetsm__Renew soap_tmp___tetsm__Renew;
	struct _wsnt__RenewResponse wsnt__RenewResponse;
	soap_default__wsnt__RenewResponse(soap, &wsnt__RenewResponse);
	soap_default___tetsm__Renew(soap, &soap_tmp___tetsm__Renew);
	soap->encodingStyle = NULL;
	if (!soap_get___tetsm__Renew(soap, &soap_tmp___tetsm__Renew, "-tetsm:Renew", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tetsm__Renew(soap, soap_tmp___tetsm__Renew.wsnt__Renew, &wsnt__RenewResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tetsm__Unsubscribe(struct soap *soap)
{	struct __tetsm__Unsubscribe soap_tmp___tetsm__Unsubscribe;
	...
	soap_default___tetsm__Unsubscribe(soap, &soap_tmp___tetsm__Unsubscribe);
	soap->encodingStyle = NULL;
	if (!soap_get___tetsm__Unsubscribe(soap, &soap_tmp___tetsm__Unsubscribe, "-tetsm:Unsubscribe", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tetsm__Unsubscribe(soap, soap_tmp___tetsm__Unsubscribe.wsnt__Unsubscribe, &wsnt__UnsubscribeResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tetnp__Subscribe(struct soap *soap)
{	struct __tetnp__Subscribe soap_tmp___tetnp__Subscribe;
	...
	soap_default___tetnp__Subscribe(soap, &soap_tmp___tetnp__Subscribe);
	soap->encodingStyle = NULL;
	if (!soap_get___tetnp__Subscribe(soap, &soap_tmp___tetnp__Subscribe, "-tetnp:Subscribe", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tetnp__Subscribe(soap, soap_tmp___tetnp__Subscribe.wsnt__Subscribe, &wsnt__SubscribeResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tetnp__GetCurrentMessage(struct soap *soap)
{	struct __tetnp__GetCurrentMessage soap_tmp___tetnp__GetCurrentMessage;
	...
	soap_default___tetnp__GetCurrentMessage(soap, &soap_tmp___tetnp__GetCurrentMessage);
	soap->encodingStyle = NULL;
	if (!soap_get___tetnp__GetCurrentMessage(soap, &soap_tmp___tetnp__GetCurrentMessage, "-tetnp:GetCurrentMessage", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tetnp__GetCurrentMessage(soap, soap_tmp___tetnp__GetCurrentMessage.wsnt__GetCurrentMessage, &wsnt__GetCurrentMessageResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tetnc__Notify(struct soap *soap)
{	struct __tetnc__Notify soap_tmp___tetnc__Notify;
	soap_default___tetnc__Notify(soap, &soap_tmp___tetnc__Notify);
	soap->encodingStyle = NULL;
	if (!soap_get___tetnc__Notify(soap, &soap_tmp___tetnc__Notify, "-tetnc:Notify", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tetnc__Notify(soap, soap_tmp___tetnc__Notify.wsnt__Notify);
	if (soap->error)
		return soap->error;
	return soap_closesock(soap);
}

SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tetpp__GetMessages(struct soap *soap)
{	struct __tetpp__GetMessages soap_tmp___tetpp__GetMessages;
	...
	soap_default___tetpp__GetMessages(soap, &soap_tmp___tetpp__GetMessages);
	soap->encodingStyle = NULL;
	if (!soap_get___tetpp__GetMessages(soap, &soap_tmp___tetpp__GetMessages, "-tetpp:GetMessages", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tetpp__GetMessages(soap, soap_tmp___tetpp__GetMessages.wsnt__GetMessages, &wsnt__GetMessagesResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tetpp__DestroyPullPoint(struct soap *soap)
{	struct __tetpp__DestroyPullPoint soap_tmp___tetpp__DestroyPullPoint;
	...
	soap_default___tetpp__DestroyPullPoint(soap, &soap_tmp___tetpp__DestroyPullPoint);
	soap->encodingStyle = NULL;
	if (!soap_get___tetpp__DestroyPullPoint(soap, &soap_tmp___tetpp__DestroyPullPoint, "-tetpp:DestroyPullPoint", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tetpp__DestroyPullPoint(soap, soap_tmp___tetpp__DestroyPullPoint.wsnt__DestroyPullPoint, &wsnt__DestroyPullPointResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tetpp__Notify(struct soap *soap)
{	struct __tetpp__Notify soap_tmp___tetpp__Notify;
	soap_default___tetpp__Notify(soap, &soap_tmp___tetpp__Notify);
	soap->encodingStyle = NULL;
	if (!soap_get___tetpp__Notify(soap, &soap_tmp___tetpp__Notify, "-tetpp:Notify", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tetpp__Notify(soap, soap_tmp___tetpp__Notify.wsnt__Notify);
	if (soap->error)
		return soap->error;
	return soap_closesock(soap);
}

SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tetcp__CreatePullPoint(struct soap *soap)
{	struct __tetcp__CreatePullPoint soap_tmp___tetcp__CreatePullPoint;
	...
	soap_default___tetcp__CreatePullPoint(soap, &soap_tmp___tetcp__CreatePullPoint);
	soap->encodingStyle = NULL;
	if (!soap_get___tetcp__CreatePullPoint(soap, &soap_tmp___tetcp__CreatePullPoint, "-tetcp:CreatePullPoint", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tetcp__CreatePullPoint(soap, soap_tmp___tetcp__CreatePullPoint.wsnt__CreatePullPoint, &wsnt__CreatePullPointResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tetps__Renew(struct soap *soap)
{	struct __tetps__Renew soap_tmp___tetps__Renew;
	struct _wsnt__RenewResponse wsnt__RenewResponse;
	soap_default__wsnt__RenewResponse(soap, &wsnt__RenewResponse);
	soap_default___tetps__Renew(soap, &soap_tmp___tetps__Renew);
	soap->encodingStyle = NULL;
	if (!soap_get___tetps__Renew(soap, &soap_tmp___tetps__Renew, "-tetps:Renew", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tetps__Renew(soap, soap_tmp___tetps__Renew.wsnt__Renew, &wsnt__RenewResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
	soap_serialize__wsnt__RenewResponse(soap, &wsnt__RenewResponse);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tetps__Unsubscribe(struct soap *soap)
{	struct __tetps__Unsubscribe soap_tmp___tetps__Unsubscribe;
	struct _wsnt__UnsubscribeResponse wsnt__UnsubscribeResponse;
	soap_default__wsnt__UnsubscribeResponse(soap, &wsnt__UnsubscribeResponse);
	soap_default___tetps__Unsubscribe(soap, &soap_tmp___tetps__Unsubscribe);
	soap->encodingStyle = NULL;
	if (!soap_get___tetps__Unsubscribe(soap, &soap_tmp___tetps__Unsubscribe, "-tetps:Unsubscribe", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tetps__Unsubscribe(soap, soap_tmp___tetps__Unsubscribe.wsnt__Unsubscribe, &wsnt__UnsubscribeResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
	soap_serialize__wsnt__UnsubscribeResponse(soap, &wsnt__UnsubscribeResponse);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tetps__PauseSubscription(struct soap *soap)
{	struct __tetps__PauseSubscription soap_tmp___tetps__PauseSubscription;
	...
	soap_default___tetps__PauseSubscription(soap, &soap_tmp___tetps__PauseSubscription);
	soap->encodingStyle = NULL;
	if (!soap_get___tetps__PauseSubscription(soap, &soap_tmp___tetps__PauseSubscription, "-tetps:PauseSubscription", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tetps__PauseSubscription(soap, soap_tmp___tetps__PauseSubscription.wsnt__PauseSubscription, &wsnt__PauseSubscriptionResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tetps__ResumeSubscription(struct soap *soap)
{	struct __tetps__ResumeSubscription soap_tmp___tetps__ResumeSubscription;
	...
	soap_default___tetps__ResumeSubscription(soap, &soap_tmp___tetps__ResumeSubscription);
	soap->encodingStyle = NULL;
	if (!soap_get___tetps__ResumeSubscription(soap, &soap_tmp___tetps__ResumeSubscription, "-tetps:ResumeSubscription", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tetps__ResumeSubscription(soap, soap_tmp___tetps__ResumeSubscription.wsnt__ResumeSubscription, &wsnt__ResumeSubscriptionResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tetpps__PullMessages(struct soap *soap)
{	struct __tetpps__PullMessages soap_tmp___tetpps__PullMessages;
	...
	soap_default___tetpps__PullMessages(soap, &soap_tmp___tetpps__PullMessages);
	soap->encodingStyle = NULL;
	if (!soap_get___tetpps__PullMessages(soap, &soap_tmp___tetpps__PullMessages, "-tetpps:PullMessages", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tetpps__PullMessages(soap, soap_tmp___tetpps__PullMessages.tev__PullMessages, &tev__PullMessagesResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tetpps__Seek(struct soap *soap)
{	struct __tetpps__Seek soap_tmp___tetpps__Seek;
	struct _tev__SeekResponse tev__SeekResponse;
	soap_default__tev__SeekResponse(soap, &tev__SeekResponse);
	soap_default___tetpps__Seek(soap, &soap_tmp___tetpps__Seek);
	soap->encodingStyle = NULL;
	if (!soap_get___tetpps__Seek(soap, &soap_tmp___tetpps__Seek, "-tetpps:Seek", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tetpps__Seek(soap, soap_tmp___tetpps__Seek.tev__Seek, &tev__SeekResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tetpps__SetSynchronizationPoint(struct soap *soap)
{	struct __tetpps__SetSynchronizationPoint soap_tmp___tetpps__SetSynchronizationPoint;
	...
	soap_default___tetpps__SetSynchronizationPoint(soap, &soap_tmp___tetpps__SetSynchronizationPoint);
	soap->encodingStyle = NULL;
	if (!soap_get___tetpps__SetSynchronizationPoint(soap, &soap_tmp___tetpps__SetSynchronizationPoint, "-tetpps:SetSynchronizationPoint", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tetpps__SetSynchronizationPoint(soap, soap_tmp___tetpps__SetSynchronizationPoint.tev__SetSynchronizationPoint, &tev__SetSynchronizationPointResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
int 
soap_send___tev__Notify(struct soap *soap, const char *soap_endpoint, const char *soap_action)
{	struct __tev__Notify tev__Notify;
	...
	{	//printf("discovery_task header soap_malloc s\n");
		soap->header = (struct SOAP_ENV__Header*)soap_malloc(soap, sizeof(struct SOAP_ENV__Header));
		memset(soap->header, 0x00, sizeof(struct SOAP_ENV__Header));
	 	SET_SOAP_ENV__Noty_Header(soap, soap->header, (char *)soap_endpoint);
	}

	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
	tev__Notify.wsnt__Notify = (struct _wsnt__Notify *)soap_malloc(soap, sizeof(struct _wsnt__Notify));
	memset(tev__Notify.wsnt__Notify, 0x00, sizeof(struct _wsnt__Notify));
	__tev__Notify(soap, tev__Notify.wsnt__Notify);

	soap_serialize___tev__Notify(soap, &tev__Notify);
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__Notify(soap, &tev__Notify, "-tev:Notify", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
	{
		dvprintf("soap_send___tev_notify ERROR\r\n");
		return soap_closesock(soap);
	}
