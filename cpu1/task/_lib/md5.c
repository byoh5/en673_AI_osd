...
MD5Init(MD5_CTX *mdContext)
{
  ...
  mdContext->buf[0] = (unsigned int)0x67452301UL;
  mdContext->buf[1] = (unsigned int)0xefcdab89UL;
  mdContext->buf[2] = (unsigned int)0x98badcfeUL;
  mdContext->buf[3] = (unsigned int)0x10325476UL;
}
 ...
 */
static void
Transform(unsigned int *buf, unsigned int *in)
{
