...
typedef struct {	// Eyenix Task Infomation(Task List, Runtime counter, Status, Priority)
...
void EYENIX_vTaskGetRunTimeCntNStats( EnxTaskInfo *etiBuffer, int nBufferSize ) PRIVILEGED_FUNCTION;
void EYENIX_vTaskGetTaskName(signed char * pcBuffer) PRIVILEGED_FUNCTION;
